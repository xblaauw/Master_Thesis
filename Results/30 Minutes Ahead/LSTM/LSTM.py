...
parameters = {'col_selection'  : [[], sensors, rain, temp, pres_hum, wind_cols, irr_cols, wind_cols + irr_cols, wind_cols + sensors, dt_only],
              'HISTORY'        : [3, 5],
              'STEP_FACTOR'    : [121],
              'FILTERS1'       : [16],
              'KERNEL_SIZE1'   : [3],
...
# =============================================================================
# parameters = {'col_selection'  : [dt_only + wind_cols + irr_cols],
#               'HISTORY'        : [1],
#               'STEP_FACTOR'    : [60],
#               'FILTERS1'       : [64],
#               'KERNEL_SIZE1'   : [7],
...
# =============================================================================
# parameters = {'col_selection'  : [dt_only + wind_cols +sensors],
#               'HISTORY'        : [9],
#               'STEP_FACTOR'    : [121],
#               'FILTERS1'       : [16],
#               'KERNEL_SIZE1'   : [3],
