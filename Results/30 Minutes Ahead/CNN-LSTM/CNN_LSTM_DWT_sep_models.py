...
results_path = 'dwt_conv_lstm_30/params_1/'
...
test = pd.DataFrame(columns = ['col_selection', 'HISTORY', 'STEP_FACTOR', 
                            'LEVEL', 'WAVELET',
                            'FILTERS1', 'KERNEL_SIZE1', 'PADDING1', 'DILATION_RATE1', 'ACTIVATION1',
                            'CONV2', 'POOL_SIZE1', 'CONV_POOL2', 'DENSE_UNITS', 'DROPOUT', 'ACTIVATION2',
                            'OPTIMIZER'])
for dict_ in param_grid:
    test = test.append({                'col_selection' : dict_['col_selection'], 
...
test.to_csv(results_path + 'param_grid.csv')
